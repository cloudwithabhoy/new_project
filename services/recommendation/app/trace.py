...
forward the propagation headers. The recommendation service serves recommendations
synchronously and consumes Kafka asynchronously, so it just surfaces the trace id
into its logs so a log line in Loki links back to the trace in Tempo.
"""
